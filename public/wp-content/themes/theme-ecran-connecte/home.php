        ...
        <div class="container">
                ...
                <div class="col-md-6 order-md-2 text-center text-md-left pr-md-5">
                    ...
                    <div class="row mx-n2">
                        <div class="col-md px-2">
                            <a href="<?php echo esc_url(get_permalink(get_page_by_title_custom('Créer une information'))); ?>" class="btn btn-lg button_presentation_ecran w-100 mb-3">Créer une information</a>
                        </div>
                        <div class="col-md px-2">
                            <a href="<?php echo esc_url(get_permalink(get_page_by_title_custom('Créer une alerte'))); ?>" class="btn btn-lg button_presentation_ecran w-100 mb-3">Créer une alerte</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="masthead-followup row m-0 border border-white">
                ...
                <div class="col-md-6 p-3 p-md-5 bg-light border border-white">
                    ...
                    <a href="<?php echo esc_url(get_permalink(get_page_by_title_custom('Gestion des informations'))); ?>" class="btn btn-lg button_presentation_ecran w-100 mb-3">Voir mes informations</a>
                    <hr class="half-rule">
                    <a href="<?php echo esc_url(get_permalink(get_page_by_title_custom('Gestion des alertes'))); ?>" class="btn btn-lg button_presentation_ecran w-100 mb-3">Voir mes alertes</a>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 order-md-1 text-center text-md-left pr-md-5">
                    ...
                    <div class="row mx-n2">
                        <div class="col-md px-2">
                            <a href="<?php echo esc_url(get_permalink(get_page_by_title_custom('Créer un utilisateur'))); ?>" class="btn btn-lg button_presentation_ecran w-100 mb-3">Créer un utilisateur</a>
                        </div>
                    </div>
                </div>
            </div>
