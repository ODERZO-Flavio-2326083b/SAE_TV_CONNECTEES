...
async function populateFormWithCssVariables() {
    const cssFileUrl = "https://sarrazin.alwaysdata.net/wp-content/themes/theme-ecran-connecte/assets/css/global/global-" + document.getElementById('cssFileSelector').value +".css";
