...
function block_alert()
{
    ...
    register_block_type(
        'tvconnecteeamu/add-alert', array(
...
function block_alert_management()
{
    ...
    register_block_type(
        'tvconnecteeamu/manage-alert', array(
...
function block_alert_modify()
{
    ...
    register_block_type(
        'tvconnecteeamu/modify-alert', array(
...
function block_code_management()
{
    ...
    register_block_type(
        'tvconnecteeamu/manage-code', array(
...
function block_code_modify()
{
    ...
    register_block_type(
        'tvconnecteeamu/modify-code', array(
...
function block_information()
{
    ...
    register_block_type(
        'tvconnecteeamu/add-information', array(
...
function block_information_management()
{
    ...
    register_block_type(
        'tvconnecteeamu/manage-information', array(
...
function block_information_modify()
{
    ...
    register_block_type(
        'tvconnecteeamu/modify-information', array(
...
function block_schedules()
{
    ...
    register_block_type(
        'tvconnecteeamu/schedules', array(
...
function block_creation_user()
{
    ...
    register_block_type(
        'tvconnecteeamu/creation-user', array(
...
function block_management_user()
{
    ...
    register_block_type(
        'tvconnecteeamu/management-user', array(
...
function block_user_modify()
{
    ...
    register_block_type(
        'tvconnecteeamu/modify-user', array(
...
function block_choose_account()
{
    ...
    register_block_type(
        'tvconnecteeamu/choose-account', array(
...
function block_delete_account()
{
    ...
    register_block_type(
        'tvconnecteeamu/delete-account', array(
...
function block_password_modify()
{
    ...
    register_block_type(
        'tvconnecteeamu/modify-pass', array(
...
function block_modif_css()
{
    ...
    register_block_type(
        'tvconnecteeamu/modify-css', array(
...
function block_department_add()
{
    ...
    register_block_type(
        'tvconnecteeamu/add-department', array(
...
function block_department_modify()
{
    ...
    register_block_type(
        'tvconnecteeamu/modify-department', array(
...
function block_department_displayDeptTable()
{
    ...
    register_block_type(
        'tvconnecteeamu/showall-department', array(
