...
class AlertRestController extends WP_REST_Controller
{
     ...
     * les callbacks, les contrôles de
     ...
     *
     * Cette méthode renvoie une réponse de l'API REST contenant
     * une liste de toutes les alertes
     * enregistrées dans le système. Elle utilise
     * le gestionnaire d'alertes pour récupérer les
     * informations nécessaires. Si la récupération
     * des alertes est réussie, elle retourne un
     ...
     *
     * @return WP_REST_Response Une réponse de l'API REST indiquant le succès
     * ou l'échec de la mise à jour de l'alerte.
     *
     * @version 1.0
     * @date    16-09-2024
     */
     ...
     * Cette méthode appelle la méthode de vérification des permissions pour les
     * éléments afin de déterminer si l'utilisateur a les droits nécessaires
     * pour supprimer une alerte. Seuls les utilisateurs ayant
     ...
     *
     * @return array|null Un tableau de codes ADE valides ou
     * null si un code est invalide.
     *
     * @version 1.0
     * @date    2024-09-16
     */
    private function _findAdeCodes($alert, $codes)
    {
