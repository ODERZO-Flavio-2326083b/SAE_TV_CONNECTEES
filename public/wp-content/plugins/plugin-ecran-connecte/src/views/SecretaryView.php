...
class SecretaryView extends UserView
{
     ...
     * alertes, gérer les informations et alertes existantes, ajouter des
     * utilisateurs, et mettre à jour le système. Les boutons de navigation
     * permettent de rediriger vers les pages appropriées.
     *
    ...
    public function displayWelcomeAdmin(): string
    {
        ...
        <div class="row">
            ...
            . '" class="btn btn-lg button_presentation_ecran w-100 mb-3">Créer une 
                        information</a>
                    </div>
                    <div class="col-md px-2">
                        <a href="'
            . esc_url(get_permalink(get_page_by_title_custom("Créer une alerte")))
            . '" class="btn btn-lg button_presentation_ecran w-100 mb-3">Créer une 
                        alerte</a>
                    </div>
                </div>
        ...
        <div class="masthead-followup row m-0 border border-white">
            <div class="col-md-6 p-3 p-md-5 bg-light border border-white">
                <h3><img src="' . TV_PLUG_PATH . '/public/img/+.png" alt="Ajouter une
                 information/alerte" class="logo">Ajouter</h3>
                <p>Ajouter une information ou une alerte. Elles seront affichées le 
                lendemain sur toutes les télévisions</p>
                <a href="'
            . esc_url(
                get_permalink(get_page_by_title_custom("Créer une information"))
            )
            . '" class="btn btn-lg button_presentation_ecran w-100 mb-3">Créer une 
                information</a>
                <hr class="half-rule">
            ...
            <div class="col-md-6 p-3 p-md-5 bg-light border border-white">
                ...
                <p>Voir toutes les informations et alertes déjà publiées. Vous pouvez
                 les supprimers, les modifiers ou bien juste les regarder</p>
                <a href="'
            . esc_url(
                get_permalink(get_page_by_title_custom("Gestion des informations"))
            )
            . '" class="btn btn-lg button_presentation_ecran w-100 mb-3">Voir mes 
                informations</a>
                <hr class="half-rule">
                <a href="'
            . esc_url(get_permalink(get_page_by_title_custom("Gestion des alertes")))
            . '" class="btn btn-lg button_presentation_ecran w-100 mb-3">Voir mes 
                alertes</a>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6 order-md-1 text-center text-md-left pr-md-5">
                ...
                <div class="row mx-n2">
                    <div class="col-md px-2">
                        <a href="'
            . esc_url(
                get_permalink(get_page_by_title_custom("Créer un utilisateur"))
            )
            . '" class="btn btn-lg button_presentation_ecran w-100 mb-3">Créer un 
                    ...
                    <div class="col-md px-2">
                        <a href="'
            . esc_url(
                get_permalink(get_page_by_title_custom("Gestion des utilisateurs"))
            )
        ...
        <div class="row">
            <div class="col-6 mx-auto col-md-6 order-md-1">
                <img src="' . TV_PLUG_PATH . '/public/img/update.png" alt="Logo mise 
                à jour" class="img-fluid mb-3 mb-md-0">
            </div>
            <div class="col-md-6 order-md-2 text-center text-md-left pr-md-5">
                ...
                l\'administration</p>
                <form method="post">
                    <button type="submit" class="btn btn-lg button_presentation_ecran
