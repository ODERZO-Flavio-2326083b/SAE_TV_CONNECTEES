...
class CodeAdeView extends View
{
     ...
     *
     * Cette méthode génère un formulaire HTML pour la création d'un code ADE. Le formulaire inclut des champs pour saisir un titre, un code ADE et un type de code (Année, Groupe, Demi-groupe).
     * Les champs sont soumis à des validations basiques comme des contraintes de longueur et de type pour les champs texte.
     *
     * @return string
     ...
     *
     * Cette méthode génère un formulaire HTML permettant de modifier un code ADE existant. Le formulaire est pré-rempli
     * avec le titre, le code et le type du code ADE à modifier. L'utilisateur peut ajuster ces valeurs avant de soumettre
     * le formulaire pour effectuer les modifications. Un lien de retour vers la page de gestion des codes ADE est également fourni.
     *
     ...
     *
     * Cette méthode génère les options HTML pour un élément `<select>`, permettant à l'utilisateur de choisir un type
     * de code parmi les options disponibles (Année, Groupe, Demi-Groupe). Elle met en surbrillance l'option qui est
     ...
     *
     * Cette méthode génère et retourne le code HTML affichant tous les codes ADE présents. Elle regroupe les codes
     * ADE par année, groupe et demi-groupe, et permet d'afficher des informations telles que le titre, le code,
     * le type et un lien de modification pour chaque code. La méthode construit également une table avec ces informations.
     *
     ...
     *
     * Cette méthode génère une modale indiquant que le code ADE a été ajouté avec succès. Le message de succès
     * est affiché à l'utilisateur pour lui confirmer l'ajout du code.
     *
     * @return void
     *
     * @version 1.0
     ...
     *
     * Cette méthode génère une modale indiquant que le code ADE a été modifié avec succès. Un message de
     * confirmation est affiché, et un lien est fourni pour rediriger l'utilisateur vers la page de gestion des codes ADE.
     *
     * @return void
     *
     * @version 1.0
     ...
     *
     * Cette méthode génère une modale indiquant qu'une erreur s'est produite lors de l'ajout d'un code ADE. Un message d'erreur
     * est affiché pour informer l'utilisateur que le code n'a pas pu être ajouté.
     *
     * @return void
     *
     * @version 1.0
     ...
     *
     * Cette méthode génère une modale indiquant qu'une erreur s'est produite lors de la modification d'un code ADE. Un message d'erreur
     * est affiché pour informer l'utilisateur que la modification n'a pas pu être effectuée.
     *
     * @return void
     *
     * @version 1.0
     ...
     *
     * Cette méthode affiche un message d'alerte indiquant que le titre ou le code spécifié existe déjà dans la base de données.
     * L'utilisateur est informé qu'il doit choisir un titre ou un code différent pour éviter les doublons.
     *
     * @return void
     *
     * @version 1.0
     ...
     *
     * Cette méthode affiche un message informant l'utilisateur qu'aucun code ADE n'est disponible dans la liste.
     * Elle inclut également un lien permettant à l'utilisateur de revenir à la page de gestion des codes ADE.
     *
     * @return string
     * Retourne le code HTML contenant le message et le lien de retour vers la page de gestion des codes ADE.
     *
     * @version 1.0
     * @date 08-01-2025
     */
