<?php
// TODO : Ajout de la doc du fichier
namespace Views;
...
class TechnicianView extends UserView
{
     ...
     * @date    2024-10-15
     */
    public function displayFormTechnician(array $dept, int $currDept, bool $isAdmin)
    : string
    {
        return '
        <h2>Compte technicien</h2>
        <p class="lead">Pour créer des techniciens, remplissez ce formulaire avec les
         valeurs demandées.</p>
     ...
     *
     * @param array $users        Un tableau d'objets représentant les techniciens à
     *                            afficher. Chaque objet doit implémenter la méthode
     *                            'getId()' pour obtenir l'identifiant et
