...
class TechnicianView extends UserView
{
     ...
     *
     * @param int $currDept ID du département de l'utilisateur actuel; null si c'est un admin
     ...
     * @param array $userDeptList Liste de tous les noms de départements dans le même ordre aue le tableau $users
     *
