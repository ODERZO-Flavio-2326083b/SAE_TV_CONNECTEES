...
class DepartmentView extends View
{
    ...
    public function renderModifForm(string $name) : string
    {
        ...
        <form method="post">
            <div class="form-group">
                ...
                <input class="form-control" type="text" id="dept_name" 
                name="dept_name" placeholder="Nom du département" required="" 
                minlength="2" maxlength="60" value="'. $name .'">
            </div>
    ...
    {
        $this->buildModal(
            "Ajout d'un département", "<p>Le département a bien été créé !</p>"
        );
    }
     ...
     *
     * Cette méthode génère un modal qui informe l'utilisateur que le département a
     * bien été modifié. Le message de succès
    ...
    {
        $this->buildModal(
            "Modification d'un département", "<p>Le département a bien été modifié !
</p>"
        );
    }
     ...
     * produite lors de l'ajout du département.
     * Le message d'erreur est affiché dans le modal pour indiquer à l'utilisateur
     * qu'une difficulté est survenue.
     *
     * @return void
...
<p>Erreur lors de l\'ajout du département.</p>'
        );
    }
    ...
    {
        $this->buildModal(
            'Erreur lors de la modification du département.', '<p>
Erreur lors de la mise à jour du département.</p>'
        );
    }
     ...
     * informer l'utilisateur qu'il ne peut pas créer
    ...
    public function errorNothing(): string
    {
        ...
        return '<p>Il n\'y a rien par ici</p><a href="'
            . $returnLink . '">Retour</a>';
    }
}
